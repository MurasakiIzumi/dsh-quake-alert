...
4. **灾害类型**：三个开关 —— 地震 / 紧急地震速报、海啸、气象灾害（泥石流 / 洪水 / 大雨 / 高潮）。气象灾害没有阈值可调：固定只在警戒レベル4 以上播报。
...
node tests/sync-test.cjs               # 回归测试（320 项断言）
```
...
当前版本 **0.3.0**。各版本的变更明细见 [CHANGELOG.md](./CHANGELOG.md)。
